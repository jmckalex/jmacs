...
(defface 'operator
  :doc "Operators (+ - * / && || == …)."
  :default-light    (face :foreground "#586e75")
  :default-dark     (face :foreground "#a3acb9")
  :default-midnight (face :foreground "#c9d1d9"))

(defface 'paren
  :doc "Punctuation: parentheses, brackets, braces."
  :default-light    (face :foreground "#93a1a1")
  :default-dark     (face :foreground "#8b98a6")
  :default-midnight (face :foreground "#8b949e"))
